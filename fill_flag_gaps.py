...
while i < 1082:
    ...
    if name.endswith("SSI"): name = name.replace("SSI", "TTJ")
    ...
    if name.endswith("FSA"): name = name.replace("FSA", "GTB")
    ...
    if name.endswith("BLI"): name = name.replace("BLI", "CMJ")
    ...
    if name.endswith("NZL"): name = name.replace("NZL", "OAM")
